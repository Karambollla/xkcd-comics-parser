...
func (x *SearchRequest) GetWords() string {
	if x != nil {
		return x.Words
	}
	return ""
...
func (x *SearchReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\x05words\x18\x01 \x01(\tR\x05words\x12\x14\n" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total2\xf4\x01\n" +
	"\x06Search\x128\n" +
	...
	"\vSearchIndex\x12\x15.search.SearchRequest\x1a\x13.search.SearchReply\"\x00\x12;\n" +
	"\aRebuild\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00B,Z*github.com/Karambollla/course/proto/searchb\x06proto3"
...
var file_proto_search_search_proto_depIdxs = []int32{
	...
	3, // 4: search.Search.Rebuild:input_type -> google.protobuf.Empty
	3, // 5: search.Search.Ping:output_type -> google.protobuf.Empty
	2, // 6: search.Search.Search:output_type -> search.SearchReply
	2, // 7: search.Search.SearchIndex:output_type -> search.SearchReply
	3, // 8: search.Search.Rebuild:output_type -> google.protobuf.Empty
